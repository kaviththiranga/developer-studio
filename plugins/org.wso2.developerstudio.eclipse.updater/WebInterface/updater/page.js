...
$(document).ready(function () {
	...
	$(document).on("click", ".install-icon", function(e) {
		...
		if (countSelectedFeatures === 0) {
			updateListTxt = " No new features will be Installed.";
		} else if (countSelectedFeatures === 1) {
			updateListTxt = " 1 new feature will be updated.";
		} else {
			updateListTxt = countSelectedFeatures
					+ " new features will be updated.";
		}
		$("#installSelectionSummary").text(updateListTxt);
	});
});
